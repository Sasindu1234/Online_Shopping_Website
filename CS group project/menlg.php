...
<!----Categories---->
        <div class = "small-container">
          ...
          <div class="row">
          <div class="col-4">
                    <a href="category.php"><img src="images/product-1.jpg"></a>
                    <h4 style="font-family: cursive"><b>T-Shirts</b></h4>
                    <p></p>
                </div>

                <div class="col-4">
                    <a href="category.php"><img src="images/product-12.jpg"></a>
                    <h4 style="font-family: cursive"><b>Trousers</b></h4>
                    <p></p>
                </div>

                <div class="col-4">
                    <a href="category.php"><img src="images/product-3.jpg"></a>
                    <h4 style="font-family: cursive"><b>Shorts</b></h4>
                    <p></p>
                </div>
...
<!----your favourite---->
        <div class = "small-container">
            ...
            <?php
               ...
               $sql = "SELECT * FROM item WHERE Item_Brand ='$Brand' AND Item_gen = 'Male'";
...
<!----loyalty offers--->
            ...
            <?php
               ...
               connect();
               $sql = "SELECT * FROM item WHERE Item_cate = 'Offer' AND Item_gen = 'Male'";
              $result = mysqli_query($conn, $sql);

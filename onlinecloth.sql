...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2022 at 11:48 AM
...
--
ALTER TABLE `deliver`
  MODIFY `del_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT for table `qustion`
--
ALTER TABLE `qustion`
  MODIFY `que_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
COMMIT;
